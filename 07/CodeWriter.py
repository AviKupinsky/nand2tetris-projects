...
class CodeWriter:
    ...
    def write(self, args: list):
        """
        in this function we find thar arg we got and from
         there continue the process what need to be in the output file
        :param args: is the aru we got from the file
        """
    ...
    def write_arithmetic(self, command: str) -> None:
        """
        in this function we got a str command, based on the str we decide how to continue
        Args:
    ...
    def write_push_pop(self, command: str, segment: str, index: int) -> None:
        """
        in this function we got a command of push are pop.
         based on the command we continue to write the output
         into there own function.
        Args:
    ...
    def write_label(self, label: str):
        """
        in this function we write a label that we got.
        :param label:a random name
        """
        self.output_file.write("(" + label + ")\n\n")

    def write_go_to(self, label: str):
        """
        in this function we write to go to the label name with a @.
        :param label:a random name
        """
        self.output_file.write("@" + label + "\n0;JEQ\n\n")
    ...
    def write_if(self, label: str):
        """
        in this function we write to go to the label name with a @,
        this time we only go to the label if the condition it is true.
        :param label:a random name
        """
    ...
    def write_function(self, func_name: str, num_vars: int):
        """
        in this function we write the name of the function
         and we push 0 to the stock based on the num we have.
    ...
    def write_call(self, func_name: str, num_vars: int):
        """
        in this function we write the output if there is a function call.
        :param func_name: name of the function
        :param num_vars: number
        """
    ...
    def write_return(self):
        """
        in this function we write the output if there is a retune.
        """
        txt = "@LCL\nD=M\n@R13\nM=D\n@5\nD=D-A\nA=D\nD=M\n@R14\nM=D\n"
        txt += "@SP\n AM=M-1\nD=M\n@ARG\nA=M\nM=D\n"
        txt += "@ARG\nD=M+1\n@SP\nM=D\n"
    ...
    def write_lcl_arg_this_that(self, command: str, segment: str, index: int) -> str:
        """
         in this function we write the output if the str is LCL, ARF, THIS, THAT.
        :param command: str of command
        :param segment:str of were to put it in the sp
        :param index: num
        """
    ...
    def write_constant(self, index: int) -> str:
        """
         in this function we write the output for str cont.
        :param index:num
        """
        return "@" + str(index) + "\nD=A\n@SP\nA=M\nM=D\n@SP\nM=M+1\n"
    ...
    def write_static(self, command: str, index: int) -> str:
        """
         in this function we write the output for str STC.
        :param command:str of were to put it in the sp
        :param index: num
        """
    ...
    def write_temp(self, command: str,  index: int) -> str:
        """
         in this function we write the output for str TMP.
        :param command:str of were to put it in the sp
        :param index: num
        """
        txt = "@5\n D=A\n@" + str(index) + "\nD=D+A\n@13\nM=D\n"
    ...
    def write_pointer(self, command: str,  index: int) -> str:
        """
         in this function we write the output for str POINTER.
        :param command:str of were to put it in the sp
        :param index: num
        """
        txt = "@3\nD=A\n@" + str(index) + "\nD=D+A\n@13\nM=D\n"
    ...
    def write_binary_op(self, command: str, op_map: dict) -> str:
        """
        this function is for op in binary for a few other functions
        :param command:str of were to put it in the sp
        :param op_map: depends on the str
        """
        return "@SP\nM=M-1\nA=M\nD=M\nA=A-1\nM=M" + op_map[command] + "D\n"

    def write_unary_op(self, command: str, op_map: dict) -> str:
        """
        this function is for down  binary for a few other functions
        :param command:str of were to put it in the sp
        :param op_map: depends on the str
        """
        return "@SP\nA=M-1\nM=" + op_map[command] + "M\n"
    ...
    def write_shifts(self, command: str, op_map: dict) -> str:
        """
         in this function we write the output for str shift.
        :param command:str of shifts
        :param op_map: num
        """
        return "@SP\nA=M-1\nM=M" + op_map[command] + "\n"
    ...
    def write_size_compare_op(self, command: str) -> str:
        """
        in this function we check if there is a option
         of overflow and make sure is dos not happen
